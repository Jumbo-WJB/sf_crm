package com.shufensoft.crm.common.utils.express;

import com.shufensoft.crm.common.api.express.FileItem;
import com.shufensoft.crm.common.api.express.NormalRequest;
...
//				cert.checkValidity(); // ��֤֤����Ч��
//				try {
//					cert.verify(verisign.getPublicKey());// ��֤ǩ��
//					exp = null;
//					break;
//				} catch (Exception e) {
//					exp = e;
