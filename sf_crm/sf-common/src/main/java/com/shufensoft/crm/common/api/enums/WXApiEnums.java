...
public enum WXApiEnums {
    ...
    UPLOAD("/cgi-bin/media/upload?access_token=","上传多媒体文件"),
    UPLOAD_IMG("/cgi-bin/media/uploadimg?access_token=","上传图文消息内的图片获取URL"),
    UPLOAD_NEWS("/cgi-bin/media/uploadnews?access_token=","上传图文消息素材"),
    MASS_SEND("/cgi-bin/message/mass/send?access_token=","根据OpenID列表群发");
