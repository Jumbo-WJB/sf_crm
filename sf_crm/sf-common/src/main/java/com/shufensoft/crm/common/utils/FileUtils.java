...
public class FileUtils {
    ...
    public static String saveFile(FileItem imageItem, String savePath) throws Exception{
        ...
        String newName = com.shufensoft.crm.common.utils.StringUtils.getUUID() + getSuffix(imageName);
    ...
    public static String saveFile(MultipartFile multipartFile, String savePath) throws Exception{
        ...
        String newName = "";
        String uuid = com.shufensoft.crm.common.utils.StringUtils.getUUID();
        if(suffixName.toLowerCase().endsWith("bmp")){
            newName = uuid + ".jpg";
            BmpReader.bmpTojpg(multipartFile.getInputStream(), savePath + newName);
        } else {
