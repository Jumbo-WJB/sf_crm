 ...
 *  @date 2015/4/12 16:21  
 */
public class TestEmayClient {
    public static String softwareSerialNo = "0SDK-EBB-6688-JFZSM";// 软件序列号,请通过亿美销售人员获取
    public static String key = "shufensoft";// 序列号首次激活时自己设定
    public static String password = "959858";// 密码,请通过亿美销售人员获取
...
//    }
    ...
    public static void testSendSMS() {
        try {
            int i = SingletonClient.getClient().sendSMS(new String[] { "18042402333",""}, "亲爱的crm客户，您好！关注公众号数粉科技，您可以收到红包！【数粉科技crm】", "test",5);// 带扩展码
