 ...
 */
package com.shufensoft.crm.polySpire.interceptor;
...
public class DigestLogInterceptor extends BaseDigestLogInterceptor {
    ...
    private static final Logger dalLogger = Logger
            .getLogger(LoggerNames.CRM_DAL_DIGEST);

    /**
     * BIZ层摘要日志
     */
    private static final Logger bizLogger = Logger
            .getLogger(LoggerNames.CRM_BIZ_DIGEST);
    ...
    private static final Logger controllerLogger = Logger
            .getLogger(LoggerNames.CRM_CONTROLLER_DIGEST);

    /**
     * 其他层摘要日志
     */
    private static final Logger otherLogger = Logger
            .getLogger(LoggerNames.CRM_OTHER_DIGEST);

    /**
     * 拦截包的名字
     */
    private static final String DAO_PACKAGE_PREX = "com.shufensoft.crm.biz.dao";

    /**
     * 拦截包的名字
     */
    private static final String BIZ_PACKAGE_PREX = "com.shufensoft.crm.biz";

    /**
     * 拦截包的名字
     */
    private static final String CONTROLLER_PACKAGE_PREX = "com.shufensoft.crm.web.api";
