package com.shufensoft.crm.biz.domain.generation.permission;
...
public class AdminResourceExample {
    ...
    public void addMaxResourceIdQueryColumn() {
        this.queryColumns.add("max(resource_id) max_id");
    }

    public void addMinResourceIdQueryColumn() {
        this.queryColumns.add("min(resource_id) min_id");
    }

    public void addAvgResourceIdQueryColumn() {
        this.queryColumns.add(" avg(resource_id) avg_id");
    }
    ...
    public void addMaxParentResourceIdQueryColumn() {
        this.queryColumns.add("max(parent_resource_id) max_id");
    }

    public void addMinParentResourceIdQueryColumn() {
        this.queryColumns.add("min(parent_resource_id) min_id");
    }

    public void addAvgParentResourceIdQueryColumn() {
        this.queryColumns.add(" avg(parent_resource_id) avg_id");
    }
    ...
    public void addMaxStyleQueryColumn() {
        this.queryColumns.add("max(style) max_id");
    }

    public void addMinStyleQueryColumn() {
        this.queryColumns.add("min(style) min_id");
    }

    public void addAvgStyleQueryColumn() {
        this.queryColumns.add(" avg(style) avg_id");
    }
    ...
    public void addMaxUrlQueryColumn() {
        this.queryColumns.add("max(url) max_id");
    }

    public void addMinUrlQueryColumn() {
        this.queryColumns.add("min(url) min_id");
    }

    public void addAvgUrlQueryColumn() {
        this.queryColumns.add(" avg(url) avg_id");
    }
    ...
    public void addMaxDescriptionQueryColumn() {
        this.queryColumns.add("max(description) max_id");
    }

    public void addMinDescriptionQueryColumn() {
        this.queryColumns.add("min(description) min_id");
    }

    public void addAvgDescriptionQueryColumn() {
        this.queryColumns.add(" avg(description) avg_id");
    }
    ...
    public void addMaxPriorityQueryColumn() {
        this.queryColumns.add("max(priority) max_id");
    }

    public void addMinPriorityQueryColumn() {
        this.queryColumns.add("min(priority) min_id");
    }

    public void addAvgPriorityQueryColumn() {
        this.queryColumns.add(" avg(priority) avg_id");
    }
