...
public class AdminUserRole {
    ...
    /** 与 avg(roleId) 映射**/
    private Long avgRoleId;

    /** 与 count(roleId) 映射**/
    private Long countRoleId;

    /** 与 sum(roleId) 映射**/
    private Long sumRoleId;

    /** adminUserId属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String adminUserIdExpression;

    /** 与 max(adminUserId) 映射**/
    private Long maxAdminUserId;

    /** 与 min(adminUserId) 映射**/
    private Long minAdminUserId;

    /** 与 avg(adminUserId) 映射**/
    private Long avgAdminUserId;

    /** 与 count(adminUserId) 映射**/
    private Long countAdminUserId;

    /** 与 sum(adminUserId) 映射**/
    private Long sumAdminUserId;
}