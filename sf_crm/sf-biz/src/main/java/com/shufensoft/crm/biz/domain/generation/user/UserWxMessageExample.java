...
public class UserWxMessageExample {
    ...
    public void addMsgIdQueryColumn() {
        this.queryColumns.add("msg_id");
    }

    public void addMaxMsgIdQueryColumn() {
        this.queryColumns.add("max(msg_id) max_msg_id");
    }

    public void addMinMsgIdQueryColumn() {
        this.queryColumns.add("min(msg_id) min_msg_id");
    }

    public void addAvgMsgIdQueryColumn() {
        this.queryColumns.add(" avg(msg_id) avg_msg_id");
    }

    public void addCountMsgIdQueryColumn() {
        this.queryColumns.add(" count(msg_id) count_msg_id");
    }

    public void addSumMsgIdQueryColumn() {
        this.queryColumns.add(" sum(msg_id) sum_msg_id");
    }
    ...
    public void addKeyWordConfigIdQueryColumn() {
        this.queryColumns.add("key_word_config_id");
    }

    public void addMaxKeyWordConfigIdQueryColumn() {
        this.queryColumns.add("max(key_word_config_id) max_key_word_config_id");
    }

    public void addMinKeyWordConfigIdQueryColumn() {
        this.queryColumns.add("min(key_word_config_id) min_key_word_config_id");
    }

    public void addAvgKeyWordConfigIdQueryColumn() {
        this.queryColumns.add(" avg(key_word_config_id) avg_key_word_config_id");
    }

    public void addCountKeyWordConfigIdQueryColumn() {
        this.queryColumns.add(" count(key_word_config_id) count_key_word_config_id");
    }

    public void addSumKeyWordConfigIdQueryColumn() {
        this.queryColumns.add(" sum(key_word_config_id) sum_key_word_config_id");
    }
    ...
    public void addReplyTypeQueryColumn() {
        this.queryColumns.add("reply_type");
    }

    public void addMaxReplyTypeQueryColumn() {
        this.queryColumns.add("max(reply_type) max_reply_type");
    }

    public void addMinReplyTypeQueryColumn() {
        this.queryColumns.add("min(reply_type) min_reply_type");
    }

    public void addAvgReplyTypeQueryColumn() {
        this.queryColumns.add(" avg(reply_type) avg_reply_type");
    }

    public void addCountReplyTypeQueryColumn() {
        this.queryColumns.add(" count(reply_type) count_reply_type");
    }

    public void addSumReplyTypeQueryColumn() {
        this.queryColumns.add(" sum(reply_type) sum_reply_type");
    }
    ...
    public void addToUserNameQueryColumn() {
        this.queryColumns.add("to_user_name");
    }

    public void addMaxToUserNameQueryColumn() {
        this.queryColumns.add("max(to_user_name) max_to_user_name");
    }

    public void addMinToUserNameQueryColumn() {
        this.queryColumns.add("min(to_user_name) min_to_user_name");
    }

    public void addAvgToUserNameQueryColumn() {
        this.queryColumns.add(" avg(to_user_name) avg_to_user_name");
    }

    public void addCountToUserNameQueryColumn() {
        this.queryColumns.add(" count(to_user_name) count_to_user_name");
    }

    public void addSumToUserNameQueryColumn() {
        this.queryColumns.add(" sum(to_user_name) sum_to_user_name");
    }

    public void addFromUserNameQueryColumn() {
        this.queryColumns.add("from_user_name");
    }

    public void addMaxFromUserNameQueryColumn() {
        this.queryColumns.add("max(from_user_name) max_from_user_name");
    }

    public void addMinFromUserNameQueryColumn() {
        this.queryColumns.add("min(from_user_name) min_from_user_name");
    }

    public void addAvgFromUserNameQueryColumn() {
        this.queryColumns.add(" avg(from_user_name) avg_from_user_name");
    }

    public void addCountFromUserNameQueryColumn() {
        this.queryColumns.add(" count(from_user_name) count_from_user_name");
    }

    public void addSumFromUserNameQueryColumn() {
        this.queryColumns.add(" sum(from_user_name) sum_from_user_name");
    }
    ...
    public void addPicUrlQueryColumn() {
        this.queryColumns.add("pic_url");
    }

    public void addMaxPicUrlQueryColumn() {
        this.queryColumns.add("max(pic_url) max_pic_url");
    }

    public void addMinPicUrlQueryColumn() {
        this.queryColumns.add("min(pic_url) min_pic_url");
    }

    public void addAvgPicUrlQueryColumn() {
        this.queryColumns.add(" avg(pic_url) avg_pic_url");
    }

    public void addCountPicUrlQueryColumn() {
        this.queryColumns.add(" count(pic_url) count_pic_url");
    }

    public void addSumPicUrlQueryColumn() {
        this.queryColumns.add(" sum(pic_url) sum_pic_url");
    }
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andKeyWordConfigIdIsNull() {
            addCriterion("key_word_config_id is null");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdIsNotNull() {
            addCriterion("key_word_config_id is not null");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdEqualTo(Long value) {
            addCriterion("key_word_config_id =", value, "keyWordConfigId");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdNotEqualTo(Long value) {
            addCriterion("key_word_config_id <>", value, "keyWordConfigId");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdGreaterThan(Long value) {
            addCriterion("key_word_config_id >", value, "keyWordConfigId");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdGreaterThanOrEqualTo(Long value) {
            addCriterion("key_word_config_id >=", value, "keyWordConfigId");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdLessThan(Long value) {
            addCriterion("key_word_config_id <", value, "keyWordConfigId");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdLessThanOrEqualTo(Long value) {
            addCriterion("key_word_config_id <=", value, "keyWordConfigId");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdIn(List<Long> values) {
            addCriterion("key_word_config_id in", values, "keyWordConfigId");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdNotIn(List<Long> values) {
            addCriterion("key_word_config_id not in", values, "keyWordConfigId");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdBetween(Long value1, Long value2) {
            addCriterion("key_word_config_id between", value1, value2, "keyWordConfigId");
            return (Criteria) this;
        }

        public Criteria andKeyWordConfigIdNotBetween(Long value1, Long value2) {
            addCriterion("key_word_config_id not between", value1, value2, "keyWordConfigId");
            return (Criteria) this;
        }
