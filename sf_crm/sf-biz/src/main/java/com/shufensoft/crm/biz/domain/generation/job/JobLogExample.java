...
public class JobLogExample {
    ...
    public void addErrorMsgQueryColumn() {
        this.queryColumns.add("error_msg");
    }

    public void addMaxErrorMsgQueryColumn() {
        this.queryColumns.add("max(error_msg) max_error_msg");
    }

    public void addMinErrorMsgQueryColumn() {
        this.queryColumns.add("min(error_msg) min_error_msg");
    }

    public void addAvgErrorMsgQueryColumn() {
        this.queryColumns.add(" avg(error_msg) avg_error_msg");
    }

    public void addCountErrorMsgQueryColumn() {
        this.queryColumns.add(" count(error_msg) count_error_msg");
    }

    public void addSumErrorMsgQueryColumn() {
        this.queryColumns.add(" sum(error_msg) sum_error_msg");
    }
