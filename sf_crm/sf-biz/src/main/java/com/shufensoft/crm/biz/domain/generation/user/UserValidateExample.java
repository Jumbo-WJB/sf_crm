...
public class UserValidateExample {
    ...
    public void addMaxCodeQueryColumn() {
        this.queryColumns.add("max(code) max_code");
    }

    public void addMinCodeQueryColumn() {
        this.queryColumns.add("min(code) min_code");
    }

    public void addAvgCodeQueryColumn() {
        this.queryColumns.add(" avg(code) avg_code");
    }

    public void addCountCodeQueryColumn() {
        this.queryColumns.add(" count(code) count_code");
    }

    public void addSumCodeQueryColumn() {
        this.queryColumns.add(" sum(code) sum_code");
    }

    public void addValidateDateQueryColumn() {
        this.queryColumns.add("validate_date");
    }

    public void addMaxValidateDateQueryColumn() {
        this.queryColumns.add("max(validate_date) max_validate_date");
    }

    public void addMinValidateDateQueryColumn() {
        this.queryColumns.add("min(validate_date) min_validate_date");
    }

    public void addAvgValidateDateQueryColumn() {
        this.queryColumns.add(" avg(validate_date) avg_validate_date");
    }

    public void addCountValidateDateQueryColumn() {
        this.queryColumns.add(" count(validate_date) count_validate_date");
    }

    public void addSumValidateDateQueryColumn() {
        this.queryColumns.add(" sum(validate_date) sum_validate_date");
    }
    ...
    public void addInvalidTimeQueryColumn() {
        this.queryColumns.add("invalid_time");
    }

    public void addMaxInvalidTimeQueryColumn() {
        this.queryColumns.add("max(invalid_time) max_invalid_time");
    }

    public void addMinInvalidTimeQueryColumn() {
        this.queryColumns.add("min(invalid_time) min_invalid_time");
    }

    public void addAvgInvalidTimeQueryColumn() {
        this.queryColumns.add(" avg(invalid_time) avg_invalid_time");
    }

    public void addCountInvalidTimeQueryColumn() {
        this.queryColumns.add(" count(invalid_time) count_invalid_time");
    }

    public void addSumInvalidTimeQueryColumn() {
        this.queryColumns.add(" sum(invalid_time) sum_invalid_time");
    }
