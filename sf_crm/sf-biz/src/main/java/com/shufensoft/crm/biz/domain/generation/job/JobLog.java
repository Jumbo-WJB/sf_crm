...
public class JobLog {
     ...
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String errorMsgExpression;

    /** 与 max(errorMsg) 映射**/
    private Long maxErrorMsg;

    /** 与 min(errorMsg) 映射**/
    private Long minErrorMsg;

    /** 与 avg(errorMsg) 映射**/
    private Long avgErrorMsg;

    /** 与 count(errorMsg) 映射**/
    private Long countErrorMsg;

    /** 与 sum(errorMsg) 映射**/
    private String sumErrorMsg;
}