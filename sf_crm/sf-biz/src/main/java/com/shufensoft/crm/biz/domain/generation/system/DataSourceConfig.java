...
public class DataSourceConfig {
    ...
    /** datasourceName属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String datasourceNameExpression;

    /** driverClassName属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String driverClassNameExpression;
     ...
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String passwdExpression;

    /** initialPoolSize属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String initialPoolSizeExpression;

    /** maxActive属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String maxActiveExpression;

    /** minIdle属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String minIdleExpression;
}