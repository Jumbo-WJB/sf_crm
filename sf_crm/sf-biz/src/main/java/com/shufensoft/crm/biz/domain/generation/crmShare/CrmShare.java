...
public class CrmShare {
    ...
    /** 分享对象类型，hontbao:红包sigh：签到game:游戏 */
    ...
    /** crmShareId属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String crmShareIdExpression;
    ...
    /** sponsorUserId属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String sponsorUserIdExpression;

    /** receiveUserId属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String receiveUserIdExpression;

    /** receiveTime属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    ...
    /** shareBizType属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String shareBizTypeExpression;
}