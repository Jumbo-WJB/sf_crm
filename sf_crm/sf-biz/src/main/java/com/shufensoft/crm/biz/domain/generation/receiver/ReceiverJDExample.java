...
public class ReceiverJDExample {
    ...
    public void addFullnameQueryColumn() {
        this.queryColumns.add("fullname");
    }

    public void addMaxFullnameQueryColumn() {
        this.queryColumns.add("max(fullname) max_fullname");
    }

    public void addMinFullnameQueryColumn() {
        this.queryColumns.add("min(fullname) min_fullname");
    }

    public void addAvgFullnameQueryColumn() {
        this.queryColumns.add(" avg(fullname) avg_fullname");
    }

    public void addCountFullnameQueryColumn() {
        this.queryColumns.add(" count(fullname) count_fullname");
    }

    public void addSumFullnameQueryColumn() {
        this.queryColumns.add(" sum(fullname) sum_fullname");
    }

    public void addTelephoneQueryColumn() {
        this.queryColumns.add("telephone");
    }

    public void addMaxTelephoneQueryColumn() {
        this.queryColumns.add("max(telephone) max_telephone");
    }

    public void addMinTelephoneQueryColumn() {
        this.queryColumns.add("min(telephone) min_telephone");
    }

    public void addAvgTelephoneQueryColumn() {
        this.queryColumns.add(" avg(telephone) avg_telephone");
    }

    public void addCountTelephoneQueryColumn() {
        this.queryColumns.add(" count(telephone) count_telephone");
    }

    public void addSumTelephoneQueryColumn() {
        this.queryColumns.add(" sum(telephone) sum_telephone");
    }
    ...
    public void addFullAddressQueryColumn() {
        this.queryColumns.add("full_address");
    }

    public void addMaxFullAddressQueryColumn() {
        this.queryColumns.add("max(full_address) max_full_address");
    }

    public void addMinFullAddressQueryColumn() {
        this.queryColumns.add("min(full_address) min_full_address");
    }

    public void addAvgFullAddressQueryColumn() {
        this.queryColumns.add(" avg(full_address) avg_full_address");
    }

    public void addCountFullAddressQueryColumn() {
        this.queryColumns.add(" count(full_address) count_full_address");
    }

    public void addSumFullAddressQueryColumn() {
        this.queryColumns.add(" sum(full_address) sum_full_address");
    }
    ...
    public void addCountyQueryColumn() {
        this.queryColumns.add("county");
    }

    public void addMaxCountyQueryColumn() {
        this.queryColumns.add("max(county) max_county");
    }

    public void addMinCountyQueryColumn() {
        this.queryColumns.add("min(county) min_county");
    }

    public void addAvgCountyQueryColumn() {
        this.queryColumns.add(" avg(county) avg_county");
    }

    public void addCountCountyQueryColumn() {
        this.queryColumns.add(" count(county) count_county");
    }

    public void addSumCountyQueryColumn() {
        this.queryColumns.add(" sum(county) sum_county");
    }
