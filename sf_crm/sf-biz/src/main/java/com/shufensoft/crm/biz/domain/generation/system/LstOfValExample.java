...
public class LstOfValExample {
    ...
    public void addMaxValueQueryColumn() {
        this.queryColumns.add("max(value) max_id");
    }

    public void addMinValueQueryColumn() {
        this.queryColumns.add("min(value) min_id");
    }

    public void addAvgValueQueryColumn() {
        this.queryColumns.add(" avg(value) avg_id");
    }
    ...
    public void addMaxDescTextQueryColumn() {
        this.queryColumns.add("max(desc_text) max_id");
    }

    public void addMinDescTextQueryColumn() {
        this.queryColumns.add("min(desc_text) min_id");
    }

    public void addAvgDescTextQueryColumn() {
        this.queryColumns.add(" avg(desc_text) avg_id");
    }
    ...
    public void addMaxValue01QueryColumn() {
        this.queryColumns.add("max(value_01) max_id");
    }

    public void addMinValue01QueryColumn() {
        this.queryColumns.add("min(value_01) min_id");
    }

    public void addAvgValue01QueryColumn() {
        this.queryColumns.add(" avg(value_01) avg_id");
    }
    ...
    public void addMaxValue02QueryColumn() {
        this.queryColumns.add("max(value_02) max_id");
    }

    public void addMinValue02QueryColumn() {
        this.queryColumns.add("min(value_02) min_id");
    }

    public void addAvgValue02QueryColumn() {
        this.queryColumns.add(" avg(value_02) avg_id");
    }
    ...
    public void addMaxValue03QueryColumn() {
        this.queryColumns.add("max(value_03) max_id");
    }

    public void addMinValue03QueryColumn() {
        this.queryColumns.add("min(value_03) min_id");
    }

    public void addAvgValue03QueryColumn() {
        this.queryColumns.add(" avg(value_03) avg_id");
    }
    ...
    public void addMaxOrdeByQueryColumn() {
        this.queryColumns.add("max(orde_by) max_id");
    }

    public void addMinOrdeByQueryColumn() {
        this.queryColumns.add("min(orde_by) min_id");
    }

    public void addAvgOrdeByQueryColumn() {
        this.queryColumns.add(" avg(orde_by) avg_id");
    }
