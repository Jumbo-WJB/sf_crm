...
public class MarketRecordsExample {
    ...
    public void addActivityTitleQueryColumn() {
        this.queryColumns.add("activity_title");
    }

    public void addMaxActivityTitleQueryColumn() {
        this.queryColumns.add("max(activity_title) max_activity_title");
    }

    public void addMinActivityTitleQueryColumn() {
        this.queryColumns.add("min(activity_title) min_activity_title");
    }

    public void addAvgActivityTitleQueryColumn() {
        this.queryColumns.add(" avg(activity_title) avg_activity_title");
    }

    public void addCountActivityTitleQueryColumn() {
        this.queryColumns.add(" count(activity_title) count_activity_title");
    }

    public void addSumActivityTitleQueryColumn() {
        this.queryColumns.add(" sum(activity_title) sum_activity_title");
    }
