...
public class MallCategoryExample {
    ...
    public void addParentCidQueryColumn() {
        this.queryColumns.add("parent_cid");
    }

    public void addMaxParentCidQueryColumn() {
        this.queryColumns.add("max(parent_cid) max_id");
    }

    public void addMinParentCidQueryColumn() {
        this.queryColumns.add("min(parent_cid) min_id");
    }

    public void addAvgParentCidQueryColumn() {
        this.queryColumns.add(" avg(parent_cid) avg_id");
    }
    ...
    public void addMaxIsParentQueryColumn() {
        this.queryColumns.add("max(is_parent) max_id");
    }

    public void addMinIsParentQueryColumn() {
        this.queryColumns.add("min(is_parent) min_id");
    }

    public void addAvgIsParentQueryColumn() {
        this.queryColumns.add(" avg(is_parent) avg_id");
    }
