...
public class MallProperty {
    ...
    /** 属性值类型。可选值： multiCheck(枚举多选) optional(枚举单选) multiCheckText(枚举可输入多选) optionalText(枚举可输入单选) text(非枚举可输入)，默认是枚举单选 */
    private String type;
    ...
    /** isSaleProp属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String isSalePropExpression;

    /** isColorProp属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String isColorPropExpression;

    /** isEnumProp属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String isEnumPropExpression;
    ...
    private List<MallPropertyValue> propertyValueList;
