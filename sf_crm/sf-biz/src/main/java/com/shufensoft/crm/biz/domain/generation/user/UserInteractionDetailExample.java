...
public class UserInteractionDetailExample {
    ...
    public UserInteractionDetailExample() {
    ...
    public void addInteractionTimeQueryColumn() {
        this.queryColumns.add("interaction_time");
    }

    public void addMaxInteractionTimeQueryColumn() {
        this.queryColumns.add("max(interaction_time) max_interaction_time");
    }

    public void addMinInteractionTimeQueryColumn() {
        this.queryColumns.add("min(interaction_time) min_interaction_time");
    }

    public void addAvgInteractionTimeQueryColumn() {
        this.queryColumns.add(" avg(interaction_time) avg_interaction_time");
    }

    public void addCountInteractionTimeQueryColumn() {
        this.queryColumns.add(" count(interaction_time) count_interaction_time");
    }

    public void addSumInteractionTimeQueryColumn() {
        this.queryColumns.add(" sum(interaction_time) sum_interaction_time");
    }
