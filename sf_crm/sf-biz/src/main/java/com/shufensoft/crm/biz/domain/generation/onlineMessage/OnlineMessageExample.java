...
public class OnlineMessageExample {
    ...
    public void addQqQueryColumn() {
        this.queryColumns.add("qq");
    }

    public void addMaxQqQueryColumn() {
        this.queryColumns.add("max(qq) max_qq");
    }

    public void addMinQqQueryColumn() {
        this.queryColumns.add("min(qq) min_qq");
    }

    public void addAvgQqQueryColumn() {
        this.queryColumns.add(" avg(qq) avg_qq");
    }

    public void addCountQqQueryColumn() {
        this.queryColumns.add(" count(qq) count_qq");
    }

    public void addSumQqQueryColumn() {
        this.queryColumns.add(" sum(qq) sum_qq");
    }
    ...
    public void addCompanyNameQueryColumn() {
        this.queryColumns.add("company_name");
    }

    public void addMaxCompanyNameQueryColumn() {
        this.queryColumns.add("max(company_name) max_company_name");
    }

    public void addMinCompanyNameQueryColumn() {
        this.queryColumns.add("min(company_name) min_company_name");
    }

    public void addAvgCompanyNameQueryColumn() {
        this.queryColumns.add(" avg(company_name) avg_company_name");
    }

    public void addCountCompanyNameQueryColumn() {
        this.queryColumns.add(" count(company_name) count_company_name");
    }

    public void addSumCompanyNameQueryColumn() {
        this.queryColumns.add(" sum(company_name) sum_company_name");
    }
    ...
    public void addRemarkQueryColumn() {
        this.queryColumns.add("remark");
    }

    public void addMaxRemarkQueryColumn() {
        this.queryColumns.add("max(remark) max_remark");
    }

    public void addMinRemarkQueryColumn() {
        this.queryColumns.add("min(remark) min_remark");
    }

    public void addAvgRemarkQueryColumn() {
        this.queryColumns.add(" avg(remark) avg_remark");
    }

    public void addCountRemarkQueryColumn() {
        this.queryColumns.add(" count(remark) count_remark");
    }

    public void addSumRemarkQueryColumn() {
        this.queryColumns.add(" sum(remark) sum_remark");
    }
