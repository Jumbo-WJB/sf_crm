...
public class ExpressInfo {
    ...
    /** expCompany属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String expCompanyExpression;

    /** 与 max(expCompany) 映射**/
    private Long maxExpCompany;

    /** 与 min(expCompany) 映射**/
    private Long minExpCompany;

    /** 与 avg(expCompany) 映射**/
    private Long avgExpCompany;

    /** 与 count(expCompany) 映射**/
    private Long countExpCompany;

    /** 与 sum(expCompany) 映射**/
    private String sumExpCompany;

    /** mailNo属性对应的表达式属性，
     * 目前用来支持update set 字段=表达式(如:'字段+1')这种场景
     **/
    private String mailNoExpression;

    /** 与 max(mailNo) 映射**/
    private Long maxMailNo;

    /** 与 min(mailNo) 映射**/
    private Long minMailNo;

    /** 与 avg(mailNo) 映射**/
    private Long avgMailNo;

    /** 与 count(mailNo) 映射**/
    private Long countMailNo;

    /** 与 sum(mailNo) 映射**/
    private String sumMailNo;
    ...
    /** 与 avg(context) 映射**/
    private Long avgContext;

    /** 与 count(context) 映射**/
    private Long countContext;

    /** 与 sum(context) 映射**/
    private String sumContext;
}