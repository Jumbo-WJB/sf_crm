...
public class MallPropertyValueExample {
    ...
    public MallPropertyValueExample() {
    ...
    public void addPropNameQueryColumn() {
        this.queryColumns.add("prop_name");
    }

    public void addMaxPropNameQueryColumn() {
        this.queryColumns.add("max(prop_name) max_id");
    }

    public void addMinPropNameQueryColumn() {
        this.queryColumns.add("min(prop_name) min_id");
    }

    public void addAvgPropNameQueryColumn() {
        this.queryColumns.add(" avg(prop_name) avg_id");
    }

    public void addVidQueryColumn() {
        this.queryColumns.add("vid");
    }

    public void addMaxVidQueryColumn() {
        this.queryColumns.add("max(vid) max_id");
    }

    public void addMinVidQueryColumn() {
        this.queryColumns.add("min(vid) min_id");
    }

    public void addAvgVidQueryColumn() {
        this.queryColumns.add(" avg(vid) avg_id");
    }
