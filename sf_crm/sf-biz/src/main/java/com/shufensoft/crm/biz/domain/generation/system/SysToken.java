...
public class SysToken {
    ...
    /** token来源；foreground:前台；background后台 */
    ...
    /** 与 avg(token) 映射**/
    private Long avgToken;

    /** 与 count(token) 映射**/
    private Long countToken;

    /** 与 count(distincttoken) 映射**/
    private Long countDistinctToken;
    ...
    /** 与 count(distinctgmtExpired) 映射**/
    private Long countDistinctGmtExpired;
