...
public class AdminUserRoleExample {
    ...
    public void addMaxRoleIdQueryColumn() {
        this.queryColumns.add("max(role_id) max_role_id");
    }

    public void addMinRoleIdQueryColumn() {
        this.queryColumns.add("min(role_id) min_role_id");
    }

    public void addAvgRoleIdQueryColumn() {
        this.queryColumns.add(" avg(role_id) avg_role_id");
    }

    public void addCountRoleIdQueryColumn() {
        this.queryColumns.add(" count(role_id) count_role_id");
    }

    public void addSumRoleIdQueryColumn() {
        this.queryColumns.add(" sum(role_id) sum_role_id");
    }

    public void addAdminUserIdQueryColumn() {
        this.queryColumns.add("admin_user_id");
    }

    public void addMaxAdminUserIdQueryColumn() {
        this.queryColumns.add("max(admin_user_id) max_admin_user_id");
    }

    public void addMinAdminUserIdQueryColumn() {
        this.queryColumns.add("min(admin_user_id) min_admin_user_id");
    }

    public void addAvgAdminUserIdQueryColumn() {
        this.queryColumns.add(" avg(admin_user_id) avg_admin_user_id");
    }

    public void addCountAdminUserIdQueryColumn() {
        this.queryColumns.add(" count(admin_user_id) count_admin_user_id");
    }

    public void addSumAdminUserIdQueryColumn() {
        this.queryColumns.add(" sum(admin_user_id) sum_admin_user_id");
    }
