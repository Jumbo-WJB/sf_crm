...
public class TestEmayClient {
    ...
    public static String password = "949467";// 密码,请通过亿美销售人员获取
    public static String type = "sale";

    public static void main(String[] args) {
        /**
         * 获取client的方法1 此示例中用SDK1Client.getClient()获取到Client对象,
    ...
    public static void testRegistEx() {
        try {
            int i = SingletonClient.getClient(type).registEx(password);
    ...
    public static void testSendSMSAddMessageId() {
        try {
            int i = SingletonClient.getClient().sendSMSEx("20110430174830",new String[] { "18057138887" }, "带有信息ID的短信", "", "GBK", 5, 123456789);
            System.out.println("testsSendScheduledSMS=====" + i);
        } catch (Exception e) {
            e.printStackTrace();
        }
