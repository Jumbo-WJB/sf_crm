    ...
    var smsTableModal = $('#smsUserTable').DataTable({
        ...
        "ajax": {
            ...
            "data": function (d) {
                ...
                var firstSource = $("#smsClientSelectedForm input[name='firstSource']:checked").val();
    ...
    var emailTableModal = $('#emailUserTable').DataTable({
        ...
        "ajax": {
            ...
            "data": function (d) {
                ...
                var firstSource = $("#emailClientSelectedForm input[name='firstSource']:checked").val();
    ...
    var wxTableModal = $('#wxUserTable').dataTable({
        ...
        "ajax": {
            ...
            "data": function (d) {
                ...
                var firstSource = $("#wxClientSelectedForm input[name='firstSource']:checked").val();
