...
package com.shufensoft.crm.web.controller.base;
...
public class BaseController {
     ...
     * @return
     */
    protected AdminUserVO getUser(HttpSession session) {
     ...
     * @return
     */
    protected Long getSellerId(HttpSession session) {
        AdminUserVO user = (AdminUserVO) session.getAttribute(LoginConstant.SESSION_KEY);
        if(user!=null){
            return user.getSellerId();
        }
        return null;
    }
